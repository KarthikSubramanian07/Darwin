...
Palette validated with the dataviz validator against this app's dark surface (`#14161c`):
winner `#2fae76` and failed `#d03b3b` pass the lightness band, chroma floor, CVD separation
(all-pairs deuteranopia ΔE 9.6), normal-vision floor (31.3) and 3:1 contrast.
